...
async function IrAbajo(params) {
  // console.log(numeroScroll, ' Dentro de IrAbajo Antes');
...
function templateSVGRutas(reversa, funcionClick = false, eventClick) {
  ...
  console.log(numeroScroll, 'numeroScroll encima de id7 Carlos');
...
document.addEventListener('click', (e) => {
  if (e.target.matches('.cerrar_imagenes')) {
    console.log(numeroScroll, 'numeroScroll');

    // numeroScroll++;
    unpauseAnimationsSVG();
    IrAbajo();
    console.log(numeroScroll, 'numeroScroll Despues');
  }
...
function galeriaCarlos(posicion) {
  ...
  $('.cerrar_imagenes').click(function (event) {
    // *
    // console.log('comprobando clicks');
    // console.log(numeroScroll, 'numeroScroll clicked');
    // unpauseAnimationsSVG();
    // IrAbajo();
    // numeroScroll == 7 ? (numeroScroll = 7) : numeroScroll++;

    // numeroScroll++;
    // !

    let id = $(this).attr('id');
    console.log(id, 'id Carlos');
